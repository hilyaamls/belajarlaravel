...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Input Mata Kuliah
                </div>

                <div class="card-body">
                <form action="{{route('simpan.makul')}}" method ="POST" class="form-item" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    ...
                    <div class="col">
                        ...
                        <input type="number" name="sks" class="form-control col-md-9" placeholder="Masukkan Jumlah SKS Mata Kuliah">
                    </div>
                </div>
                </div>
